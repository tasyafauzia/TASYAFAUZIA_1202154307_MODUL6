package com.tasyafauzia.android.tasyafauzia_1202154307_modul6;
...
import com.tasyafauzia.android.tasyafauzia_1202154307_modul6.Adapter.CommentAdapter;
import com.tasyafauzia.android.tasyafauzia_1202154307_modul6.Model.Comment;
import com.tasyafauzia.android.tasyafauzia_1202154307_modul6.Model.User;
...
public class CommentPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(CommentPost.this).load(img).into(mImgPost);
    ...
    protected void onStart() {
        ...
        databaseComments.orderByChild("timestamp").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(CommentPost.this));
                CommentAdapter commentAdapter = new CommentAdapter(CommentPost.this, listComments);
